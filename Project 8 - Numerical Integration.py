# Code by Grant Burke and Ben Croyle. Packages used are numpy, scipy, and matplotlib. The purpose of the code was to find the Riemann sum of the following equations via certain variables and subintervals.
import numpy as np
